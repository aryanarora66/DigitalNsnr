    ...
    <div className="bg-white py-24 px-4 sm:px-6 lg:px-8" style={{ paddingTop: '120px' }}>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-wrap items-center gap-4 text-sm text-gray-800"> {/* Changed to darker gray */}
        ...
        {/* Blog Content - Added darker text color */}
        <div 
