...
export default function InfluencerProcess(): JSX.Element {
  const steps: Step[] = [
    {
    ...
    {
      icon: <Heart className="h-6 w-6 text-[#eea53e]" />,
    ...
    {
      icon: <Star className="h-6 w-6 text-[#eea53e]" />,
    ...
    {
      icon: <Repeat2 className="h-6 w-6 text-[#eea53e]" />,
