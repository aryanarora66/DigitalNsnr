...
export default function GoogleAdsCTA(): JSX.Element {
  ...
  return (
    <section className="py-16 bg-gradient-to-r from-gray-900 to-gray-800 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          Let’s discuss how we can drive qualified traffic and conversions for
          your business.
        </motion.p>
        ...
        >
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }}>
            <Link
              href="/contact"
              className="bg-transparent hover:bg-white/10 border-2 border-[#eea53e]/70 text-[#f9c76b] px-8 py-3 rounded-lg font-black text-lg flex items-center justify-center transition-all duration-300"
            >
